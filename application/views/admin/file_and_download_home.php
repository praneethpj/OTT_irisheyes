...
<div class="card">
  <div class="row">
    <div class="col-md-12">
      <a class="btn btn-sm btn-primary waves-effect" href="<?php echo base_url('admin/videos_home'); ?>"> <span class="btn-label"><i class="fa fa-arrow-left"></i></span><?php echo trans('back_to_list'); ?></a>
    ...
    <div class="col-md-12">
      <div class="panel panel-border panel-primary">
        ...
        <div class="panel-body">
          <?php echo form_open_multipart(base_url('admin/movie_upload_home')); ?>           
      ...
      <div class="panel panel-border panel-primary">
        ...
        <div class="panel-body">
            <?php echo form_open(base_url() . 'admin/file_and_download_home/change_order/', array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data')); ?>
            <input type="hidden" name="videos_id" value="<?php echo $param1; ?>">
                ...
                <td>
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                      <li><a class="dropdown-item"href="<?php echo base_url('admin/file_and_download_home/edit/'. $video_file['video_file_id']); ?>"><?php echo trans('edit') ?></a></li>
