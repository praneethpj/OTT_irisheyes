<div class="card">
  <div class="row">
    <div class="col-sm-6">
      ...
      <div class="form-group">
        <label class="col-sm-3 control-label"><?php echo trans('vasttag'); ?></label>
        <div class="col-sm-6">
          <input type="text" name="live_tv_category_vasttag" class="form-control"  />
        </div>
      </div>
      <div class="form-group">
            ...
            <tr id='row_<?php echo $live_tv_category['live_tv_category_id']; ?>'>
              ...
              <td>
                <span class="d-inline-block text-truncate" style="max-width: 150px;">
                  <?php echo $live_tv_category['live_tv_category_desc']; ?>
                </span>
              </td>
              <td>
                <span class="d-inline-block text-truncate" style="max-width: 150px;">
                  <?php echo $live_tv_category['live_tv_category_vast_tag']; ?>
                </span>
              </td>
              <td>
