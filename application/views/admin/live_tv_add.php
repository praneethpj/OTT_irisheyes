...
<div class="card">
  <div class="row">
    <div class="col-sm-6">
      ...
      <div class="form-group">
        <label class="control-label "><?php echo trans('thumbnail'); ?>&nbsp; (1920*1080)</label>
        <p>
      ...
      <div class="form-group">
        <label class="control-label "><?php echo trans('poster'); ?> &nbsp; (1920*1080)</label><br>
    ...
    <div class="col-sm-6">
      ...
      <div class="form-group">
        <label class="control-label"><?php echo trans('carousel'); ?></label>
        <div class="col-sm-6">
          <div class="toggle">
            <label>
              <input type="checkbox" name="carousel" checked><span class="button-indecator"></span>
            </label>
          </div>
        </div>
      </div>
