...
<?php
$videos   = $this->db->get_where('videos_home', array('videos_id' => $param1))->result_array();
foreach ($videos as $video) :
    $actors     = explode(",", $video['stars']);
    $directors  = explode(",", $video['director']);
    $writers    = explode(",", $video['writer']);
    echo form_open(base_url() . 'admin/videos_home/update/' . $param1, array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data'));
    ?>
    <div class="row">
        <div class="col-md-6">
                ...
                <div class="card-block">
                    ...
                    <div class="row">
                        <div class="col-sm-6 pull-left">
                            <a href="<?php echo base_url() . 'admin/videos_home/#' . $param1 ?>" class="link m-l-15 text-left"> Back to list</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card cta cta--featured p-a">
                ...
                <div class="card-block">
                    <div class="form-group">
                        ...
                        <div class="profile-info-name text-center"> <img id="thumb_image" src="<?php echo $this->common_model->get_video_thumb_url_admin($param1) . '?' . time(); ?>" width="150" class="img-thumbnail" alt=""> </div>
                        <br>
