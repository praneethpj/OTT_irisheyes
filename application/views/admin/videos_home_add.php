...
<?php echo form_open(base_url() . 'admin/videos_home/add/', array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data')); ?>
<div class="row">
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        <div class="card cta cta--featured p-a">
            ...
            <div class="card-block">
                ...
                <div class="form-group">
                    <label class="control-label"><?php echo trans('button1_name'); ?></label><br>
                    <input type="text" name="button1_name" id="button1_name" class="form-control"><br>
                </div>
                <div class="form-group">
                    <label class="control-label"><?php echo trans('button1_link'); ?></label><br>
                    <input type="text" name="button1_link" id="button1_link" class="form-control"><br>
                </div>
                <div class="form-group">
                    <label class="control-label"><?php echo trans('button2_name'); ?></label><br>
                    <input type="text" name="button2_name" id="button2_name" class="form-control"><br>
                </div>
                <div class="form-group">
                    <label class="control-label"><?php echo trans('button2_link'); ?></label><br>
                    <input type="text" name="button2_link" id="button2_link" class="form-control"><br>
                </div>
                <div class="form-group">
                    <div class="offset-md-9 col-sm-3 m-t-15 pull-right">
                        <button type="submit" class="btn btn-primary waves-effect"> 
							<span class="btn-label"><i class="fa fa-plus"></i></span><?php echo trans('create'); ?> </button>
                    </div>
                </div>
            </div>
        </div>
    ...
    jQuery(document).ready(function() {
        $(document).on('click', '#import_btn', function() {
            ...
            if (!error) {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url() . "admin/import_movie_admin"; ?>',
                    data: {
                        "id": id,
                        "from": "movie",
                        "lang": lang
