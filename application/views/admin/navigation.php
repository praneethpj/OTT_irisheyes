...
<aside class="app-sidebar">
    <ul class="app-menu">
		...
		<li class="treeview <?php if ($active_menu == 66 || $active_menu == 88) { echo " is-expanded "; } ?>">
            <a href="#" class="app-menu__item" data-toggle="treeview">
                <i class="app-menu__icon fa fa-video-camera" aria-hidden="true"></i>
                <span class="app-menu__label"><?php echo trans('home_page_video') ?></span>
                <i class="treeview-indicator fa fa-angle-right"></i>
            </a>
            <ul class="treeview-menu">
                <li>
                    <a class="treeview-item <?php if ($active_menu == 66) {  echo " active "; } ?>" href="<?php echo base_url() . 'admin/videos_home_add/' ?>">
                        <i class="app-menu__icon fa fa-plus"></i>
                        <?php echo trans('new_home_page_video') ?></span>
                    </a>
                </li>
                <li>
                    <a class="treeview-item <?php if ($active_menu == 88) { echo " active "; } ?>" href="<?php echo base_url() . 'admin/videos_home/' ?>">
                        <i class="app-menu__icon fa fa-list"></i>
                        <?php echo trans('all_home_page_video') ?></span>
                    </a>
                </li>
            </ul>
        </li>
