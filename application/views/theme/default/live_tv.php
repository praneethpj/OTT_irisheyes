    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="latest-movie movie-opt">
                    <div class="movie-heading overflow-hidden"> 
						<h2><span style="font-weight:bold;"><?php echo trans('all_tv_channels'); ?></span> <span style="color:#5DC560;font-weight:bold" >&nbsp;Irish Eyes</span>  </h2>
                        <div class="disable-bottom-line"></div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12">
          <div class="latest-movie movie-opt">
            <div class="movie-heading overflow-hidden"> 
              <span style="font-weight:bold;"><?php echo $live_tv_category['live_tv_category']; ?>&nbsp;on</span><span style="color:#5DC560;font-weight:bold;" >&nbsp;Irish Eyes</span>  </h2>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12">
          <div class="owl-carousel-featured live_tv_owl_cat_<?php echo $live_tv_category['live_tv_category_id']; ?>">
