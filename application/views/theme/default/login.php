...
?>
<!-- Main Section -->
<div id="section-opt" style="padding-top: 55px;">
    <div class="container">
	<h2 class="block-title text-center" style="color:white;"><?php echo trans('signup_to_join'); ?><br>
                    <small style="color:white;"><?php echo trans('signup_text'); ?></small>
                </h2>
