	...
	<head>
		...
		<style>
			...
			.input-group-addon {
			    ...
			    color: #555;
			    text-align: center;
			    background-color: <?php if($front_end_theme =='blue'): echo "#0088cc";elseif($front_end_theme =='green'): echo "#5DC560";elseif($front_end_theme =='red'): echo "#03ad71";elseif($front_end_theme =='yellow'): echo "#FDD922";elseif($front_end_theme =='purple'): echo "#6d0eb1";else: echo "#0088cc";endif; ?>;
			    border: none;
			    border-radius: 4px;
			}
			.btn-all-movie {
