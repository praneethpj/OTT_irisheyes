  ...
  $("#owl-demo").owlCarousel({ 
	...
	<?php //elseif($slider_type == "image"):?>
			...
			<div>
					...
					<img class="owl-img" src="<?php //echo $slider->image_link;?>">
					<div class="row text-center">
				
					<a class="btn btn-danger slider-button" href="<?php //echo $slider->action_url;?>"><?php //echo $slider->action_btn_text;?></a>
					</div>
			</div>
	<?php //endforeach; ?>
</div>
