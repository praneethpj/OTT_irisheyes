                    ...
                    <div class="pp-main col-md-9 col-sm-9">
                        ...
                        <div class="ppm-content user-content row">
                            ...
                            <div class="uct-info col-md-9">
                                ...
                                <div class="block">
                                    <label><?php echo trans('join_date'); ?>:</label> <?php echo date('d M Y',strtotime($profile_info->join_date)); ?></div>
                                <div class="block">
                                    <label><?php echo trans('last_login'); ?>:</label> <?php echo date('Y-m-d H:i:s',strtotime($profile_info->last_login)); ?> </div>
                                <div class="mt20">
                                    <a href="<?php echo base_url('my-account/update'); ?>" class="btn btn-success" title=""><?php echo trans('Edit account info'); ?></a>
                                </div>
                            </div>
