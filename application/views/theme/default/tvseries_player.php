...
<div class="movie-payer">
    ...
    <?php endif; ?>
		...
		<?php 
	 		...
	 		if($len==0){;
			   ?>
			<iframe  class="responsive-embed-item" allow="autoplay *; fullscreen *" allowfullscreen="true" frameborder="0" webkitallowfullscreen="true" src="<?php echo $file_url?>">
			</iframe>
			<?php }else{ ?>
				<iframe   class="responsive-embed-item" src="<?php echo $file_url."?autoplay=false"; ?>" frameborder="0" allowfullscreen="true" webkitallowfullscreen="true" allow="autoplay=false;" mozallowfullscreen="true">
		</iframe>
		<?php } ?>
		</div>
	    <?php endif; ?>
			 ...
			 if(setlogin){
				...
				setTimeout(() => {
					if (document.activeElement.tagName === "IFRAME") {
						window.location.assign('<?php echo (base_url() . 'login?e=1') ?>');
					}
				});
				}, 100);
			 }
