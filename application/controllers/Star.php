...
class Star extends Home_Core_Controller {
        ...
        public function index($slug){
			...
			$star_desc                      = $this->common_model->get_star_desc_by_id($star_id);
			$star_type                      = $this->common_model->get_star_type_by_id($star_id);
			$star_img                       = $this->common_model->get_Star_img($star_id);
                        $config                         = array();
