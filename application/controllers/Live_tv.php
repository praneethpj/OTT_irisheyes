...

	{
		if ($slug == '' || $slug ==NULL) {        
            ...
            if($accessibility == "allowed"):
	            ...
	            $data['latest_videos']          = $this->common_model->latest_published_videos();
	            $data['latest_tv_series']       = $this->common_model->latest_published_tv_series();   
              $data['vas_tag_url']          = $this->live_tv_model->get_live_tv_category_vast_tag_by_category_id($this->live_tv_model->get_live_tv_details_by_slug($slug)->live_tv_category_id);
