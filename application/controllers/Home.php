...
class Home extends Home_Core_Controller {
  ...
  public function index() {
	...
	public function search(){
		...
		$total_rows_videos = $this->common_model->get_videos_num_rows_videos($title);
		$total_rows_movies = $this->common_model->get_videos_num_rows_movies($title);
		$this->load->library("pagination");
		$config 					= array();
		$config["base_url"] 		= base_url() . "search?".$search_string;
		$config["total_rows"] 		= $total_rows;
		$config["total_rows_all"] 	= $total_rows_videos+$total_rows_movies;
		$config["total_rows_videos"] 	= $total_rows_videos;
		$config["total_rows_movies"] 	= $total_rows_movies;
		$config["per_page"] 		= 24;
		...
		$data["all_published_videos_movie_tv_series"] = $this->common_model->get_videos_movie_tv_series($title,$config["per_page"], $page);
        $data["all_published_videos_live"] = $this->common_model->get_videos_live($title,$config["per_page"], $page);
		$data["links"] 				= $this->pagination->create_links();
		$data["total_rows_videos"] 	= $config["total_rows_videos"];
		$data["total_rows_movies"] 	= $config["total_rows_movies"] ;
		$data['total_rows_all']	    = $config["total_rows_all"];
