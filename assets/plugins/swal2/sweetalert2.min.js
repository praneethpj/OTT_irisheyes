!(function (e, t) {
    ...
    function n() {
        ...
        return new Promise(function (n, i) {
            ...
            var d,
                ...
                h = function (t) {
                    ...
                    switch (n.type) {
                        case "mouseover":
                        case "mouseup":
                            e.buttonsStyling && (s ? (a.style.backgroundColor = m(e.confirmButtonColor, -0.1)) : c && (l.style.backgroundColor = m(e.cancelButtonColor, -0.1)));
                            break;
                        case "mouseout":
                            e.buttonsStyling && (s ? (a.style.backgroundColor = e.confirmButtonColor) : c && (l.style.backgroundColor = e.cancelButtonColor));
                            break;
                        case "mousedown":
                            e.buttonsStyling && (s ? (a.style.backgroundColor = m(e.confirmButtonColor, -0.2)) : c && (l.style.backgroundColor = m(e.cancelButtonColor, -0.2)));
                            break;
                        case "click":
                            if (s && o.isVisible())
                                if (e.input) {
            ...
            var E = C(),
                V = k();
            e.reverseButtons ? E.parentNode.insertBefore(V, E) : E.parentNode.insertBefore(E, V),
                (v.previousWindowKeyDown = window.onkeydown),
                (window.onkeydown = s),
                e.buttonsStyling && ((E.style.borderLeftColor = e.confirmButtonColor), (E.style.borderRightColor = e.confirmButtonColor)),
            ...
            var T,
                j = ["input", "file", "range", "select", "radio", "checkbox", "textarea"];
            ...
            if (
                (("select" !== e.input && "radio" !== e.input) ||
                    (e.inputOptions instanceof Promise
                        ...
                        ? Y(e.inputOptions)
                        : console.error("SweetAlert2: Unexpected type of inputOptions! Expected object or Promise, got " + typeof e.inputOptions)),
        ...
        U = function (e) {
            ...
            if (e.text || e.html) {
                if ("object" == typeof e.html)
                    if (((r.innerHTML = ""), 0 in e.html)) for (d = 0; d in e.html; d++) r.appendChild(e.html[d].cloneNode(!0));
            ...
            e.progressSteps.length
                ? (q(p),
                  V(p),
                  f >= e.progressSteps.length && console.warn("SweetAlert2: Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
            ...
            e.imageUrl
                ? (x.setAttribute("src", e.imageUrl),
                  q(x),
                  e.imageWidth ? x.setAttribute("width", e.imageWidth) : x.removeAttribute("width"),
                  e.imageHeight ? x.setAttribute("height", e.imageHeight) : x.removeAttribute("height"),
                  (x.className = l.image),
            ...
            e.showConfirmButton || e.showCancelButton ? q(E) : M(E),
                ...
                e.buttonsStyling && ((i.style.backgroundColor = e.confirmButtonColor), (a.style.backgroundColor = e.cancelButtonColor)),
                ...
                e.buttonsStyling
                    ...
                    : (A(i, "styled"), A(a, "styled"), (i.style.backgroundColor = i.style.borderLeftColor = i.style.borderRightColor = ""), (a.style.backgroundColor = a.style.borderLeftColor = a.style.borderRightColor = "")),
